...
const VirtualList = ({
  ...
  const [scrollTop, setScrollTop] = require$$0.useState(0);
  const [resizeCount, setResizeCount] = require$$0.useState(0);
  const measuredDataRef = require$$0.useRef({
    measuredDataMap: {},
    lastMeasuredItemIndex: -1
  });
  const columnHeights = require$$0.useRef([]);
  require$$0.useEffect(() => {
  ...
  const estimateTotalHeight = require$$0.useCallback(() => {
  ...
  const getItemMetadata = require$$0.useCallback(
    (index) => {
      const { measuredDataMap, lastMeasuredItemIndex } = measuredDataRef.current;
  ...
  const getVisibleRange = require$$0.useCallback(() => {
    var _a;
  ...
  const visibleContent = require$$0.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxRuntimeExports.jsx("div", { className: "verney-virtual-list", children: /* @__PURE__ */ jsxRuntime.jsxRuntimeExports.jsxs(
    "div",
    {
      ref: containerRef,
      ...
      children: [
        ...
        isLoading && /* @__PURE__ */ jsxRuntime.jsxRuntimeExports.jsx("div", { className: "verney-virtual-list-loading", children: "加载中..." })
      ]
    }
  ) });
};
